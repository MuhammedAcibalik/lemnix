...
export const Logo: React.FC<LogoProps> = ({ 
  ...
  const getSize = () => {
    switch (size) {
      case 'small': return { width: 32, height: 32, fontSize: '0.875rem' };
      case 'large': return { width: 48, height: 48, fontSize: '1.5rem' };
      default: return { width: 40, height: 40, fontSize: '1.2rem' };
    }
  };
  ...
  const getPrimaryColor = () => {
    switch (color) {
      ...
      case 'primary': return '#1a237e';
      case 'gradient': return '#1a237e';
  ...
  const getAccentColor = () => {
    switch (color) {
      case 'white': return '#ff6f00';
      case 'primary': return '#ff6f00';
      ...
      {variant === 'full' && (
        <Typography
          ...
          sx={{
            ...
            color: color === 'white' ? '#ffffff' : color === 'primary' ? '#1a237e' : 'inherit',
            letterSpacing: '0.5px',
