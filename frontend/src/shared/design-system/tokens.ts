 ...
 *
 * @description
 * Comprehensive design tokens providing the foundation for the entire UI/UX system.
 * Includes color palettes, typography, spacing, shadows, gradients, and more.
 *
 * @example
 * ```tsx
...
// ============================================================================
// SPACING SYSTEM - Numeric scale with semantic aliases
// ============================================================================

/**
 * Spacing scale based on 4px (0.25rem) base unit
...
/**
 * Semantic spacing scale for common use cases
 * Maps to T-shirt sizes for easier comprehension
 */
 ...
 * Based on Tailwind's blue, emerald, and purple scales
 */
 ...
 * True neutral grays without color bias
 */
 ...
 * Provides a cooler, more modern feel
 */
...
/**
 * Functional colors - Domain-specific colors
 * Tailored for the aluminum optimization domain
 */
...
/**
 * Unified color export with semantic aliases
 * Main color system used throughout the application
 */
export const colors = {
  // Brand colors
  primary: {
  ...
  slate: slateColors,
  grey: slateColors, // Material-UI alias
 ...
 * Inter for UI, Merriweather for content, JetBrains Mono for code
 */
...
/**
 * Line height scale
 * For optimal readability across different contexts
 */
 ...
 * Includes display, heading, body, and label styles
 */
...
/**
 * Border radius scale
 * From sharp corners to fully rounded
 */
 ...
 * Includes soft, crisp, glow, inner, and semantic shadows
 */
export const shadows = {
  ...
  crisp: {
    ...
    "3xl": "0 32px 64px rgba(15, 23, 42, 0.40)",
  },
 ...
 * Includes brand, mesh, surface, semantic, and special gradients
 */
 ...
 * Based on CSS cubic-bezier curves
 */
export const easing = {
  linear: "linear",
...
/**
 * Transition system with preset and property-specific transitions
 */
 ...
 * Prevents z-index chaos by providing semantic values
 */
export const zIndex = {
  hide: -1,
  auto: "auto",
 ...
 * Ensures consistent sizing across all UI components
 */
...
/**
 * Glass morphism styles for modern UI effects
 * Creates frosted glass appearance with backdrop filters
 */
export const glass = {
  light: {
 ...
 * Aggregate of all token systems for convenience
 */
