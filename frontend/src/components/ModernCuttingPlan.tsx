...
export const ModernCuttingPlan: React.FC<ModernCuttingPlanProps> = ({ cuts }) => {
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                  ...
                  <Box>
                    ...
                    <Typography variant="body2" color="text.secondary">
                      {stockCuts.length} kesim • {stockCuts.reduce((sum, cut) => sum + (cut.segmentCount || cut.segments.length), 0)} parça
                    </Typography>
                  </Box>
                </Box>
                  ...
                  <Grid item xs={12} md={6} lg={4} key={cut.id}>
                    ...
                    >
                      ...
                      <Box sx={{ 
                        ...
                        <Box sx={{ textAlign: 'center' }}>
                          ...
                          <Typography 
                            variant="h6" 
                            fontWeight="bold"
                            color={cut.remainingLength > 500 ? 'error.main' : 'warning.main'}
                          >
                      ...
                      <Box>
                        <Box sx={{ 
                          ...
                          <Typography variant="caption" fontWeight="bold">
                            {((cut.usedLength / cut.stockLength) * 100).toFixed(1)}%
                          </Typography>
                        </Box>
                        <LinearProgress 
                          variant="determinate" 
                      ...
                      <Box sx={{ 
                        ...
                        >
                          {cut.segments.map(seg => `${seg.length}mm`).join(' + ')} + {cut.remainingLength}mm atık
                        </Typography>
                      </Box>
                    </Paper>
                  </Grid>
