...
export const ProductionPlanFiltersComponent: React.FC<
...
> = ({ filters, onFiltersChange }) => {
  ...
  const handleFilterChange = (
    field: keyof ProductionPlanFiltersType,
    value: unknown,
  ) => {
    onFiltersChange({
      ...filters,
      ...
      <Collapse in={isExpanded}>
          ...
          <Grid item xs={12} sm={6} md={3}>
            <FormControl fullWidth size="small">
              ...
              <Select
                ...
                label="Hafta"
                onChange={(e) =>
                  handleFilterChange("weekNumber", e.target.value || undefined)
                }
              >
                <MenuItem value="">
                  <em>Tüm haftalar</em>
          ...
          <Grid item xs={12} sm={6} md={3}>
            <FormControl fullWidth size="small">
              ...
              <Select
                ...
                label="Bölüm"
                onChange={(e) =>
                  handleFilterChange("bolum", e.target.value || undefined)
                }
              >
                <MenuItem value="">
                  <em>Tüm bölümler</em>
          ...
          <Grid item xs={12} sm={6} md={3}>
            <FormControl fullWidth size="small">
              ...
              <Select
                ...
                label="Öncelik"
                onChange={(e) =>
                  handleFilterChange("oncelik", e.target.value || undefined)
                }
              >
                <MenuItem value="">
        ...
        {activeFiltersCount > 0 && (
          <Box sx={{ mt: ds.spacing["2"] }}>
            <Typography
              variant="body2"
              sx={{ mb: ds.spacing["1"], fontWeight: 600, fontSize: "0.75rem" }}
            >
              Aktif Filtreler:
            </Typography>
            <Box
              sx={{ display: "flex", gap: ds.spacing["1"], flexWrap: "wrap" }}
            >
              {filters.weekNumber && (
                <Chip
