...
export const ProfileManagementPanel: React.FC = () => {
        ...
        ? [
            {
              ...
              icon: <AssignmentIcon sx={{ color: ds.colors.primary.main, fontSize: 28 }} />,
            ...
            },
            {
              ...
              icon: <CheckCircleIcon sx={{ color: ds.colors.success.main, fontSize: 28 }} />,
            ...
            },
            {
              ...
              icon: <LinkIcon sx={{ color: ds.colors.warning.main, fontSize: 28 }} />,
            ...
            },
            {
              ...
              icon: <CalendarTodayIcon sx={{ color: ds.colors.info.main, fontSize: 28 }} />,
  ...
  return (
    ...
    >
        ...
        >
          {statsCards.map((card) => (
            ...
            >
              ...
              >
                {React.cloneElement(card.icon, { sx: { ...card.icon.props.sx, fontSize: 14 } })}
              </Box>
      ...
      {statsLoading && (
        <Box sx={{ display: 'flex', justifyContent: 'center', py: ds.spacing['2'] }}>
          <CircularProgress size={20} />
        </Box>
      )}

      <CardV2 variant="outlined" sx={{ p: 0, mt: 0 }}>
        <Box sx={{ borderBottom: `1px solid ${ds.colors.neutral[200]}`, px: ds.spacing['1'] }}>
          <Tabs
            value={tabValue}
