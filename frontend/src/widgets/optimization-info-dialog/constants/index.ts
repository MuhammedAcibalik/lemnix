...
export const algorithms: Algorithm[] = [
  {
    ...
    description:
      "Parçaları büyükten küçüğe sıralar ve ilk uygun stoğa yerleştirir.",
    complexity: "O(n²)",
    efficiency: "85-90%",
    speed: "Çok Hızlı",
  ...
  },
  {
    ...
    description:
      "Aynı profil tiplerini gruplayarak optimize eder. Çoklu iş emri senaryoları için ideal.",
    complexity: "O(n²×p)",
    efficiency: "85-90%",
    speed: "Hızlı",
    pros: [
...
export const metrics: Metric[] = [
  {
    name: "Verimlilik",
    formula: "(Kullanılan / Toplam Stok) × 100",
    unit: "%",
  },
  { name: "Atık", formula: "Toplam Stok - Kullanılan", unit: "mm" },
  {
    name: "Maliyet",
    formula: "Malzeme + Kesim + Kurulum + Atık + Zaman + Enerji",
    unit: "₺",
  },
  {
    name: "Güven Skoru",
    formula: "Verimlilik × Kalite × Tutarlılık",
    unit: "0-100",
  },
];
...
export const messages = {
  ...
  overview: {
    ...
    description:
      "Bu sistem, alüminyum profil kesim işlemlerinizi optimize ederek malzeme israfını minimize eder, verimliliği maksimize eder ve maliyetleri düşürür.",
    features: {
  ...
  parameters: {
    ...
    warning: {
      title: "Önemli",
      message:
        "Parametreleri makinenizin özelliklerine ve malzeme tipine göre ayarlayın. Yanlış parametreler hatalı kesim planlarına neden olabilir.",
    },
  },
  steps: {
