              ...
              <FormControlLabel
                control={
                  <Switch
                    ...
                    onChange={(e) => onWorkshopStateChange({ materialLoaded: e.target.checked })}
                  />
                }
              ...
              <FormControlLabel
                control={
                  <Switch
                    ...
                    onChange={(e) => onWorkshopStateChange({ cuttingInProgress: e.target.checked })}
            ...
            <Box sx={{ mb: 3 }}>
              ...
              <FormControl fullWidth>
                ...
                <Select
                  ...
                  onChange={(e) => onWorkshopStateChange({ currentMaterial: e.target.value })}
                  label="Malzeme Seçin"
                >
