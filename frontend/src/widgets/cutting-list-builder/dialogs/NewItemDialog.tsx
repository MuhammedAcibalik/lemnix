...
interface NewItemDialogProps {
  ...
  onProfileChange: (profileId: string, field: keyof ProfileFormItem, value: string) => void;
  onFormChange: (field: keyof Omit<WorkOrderForm, 'profiles'>, value: string) => void;
        ...
        <Stack direction="row" alignItems="center" spacing={ds.spacing['2']} sx={{ flex: 1 }}>
          <Box
            sx={{
              ...
              background: isComplete ? ds.colors.success.main : ds.colors.primary.main,
              display: 'flex',
              alignItems: 'center',
            ...
            <Stack spacing={ds.spacing['2']}>
              ...
              <Stack direction="row" spacing={ds.spacing['2']}>
                ...
                <TextField
                  label="Tarih"
                  type="date"
                  value={newItemForm.date || new Date().toISOString().split('T')[0]}
              ...
              <Stack direction="row" spacing={ds.spacing['2']}>
                ...
                <FormControl fullWidth size="small">
                  ...
                  <Select
                    ...
                    onChange={(e) => onFormChange('priority', e.target.value as string)}
                    label="Öncelik"
                  >
              ...
              <Stack direction="row" spacing={ds.spacing['2']}>
                <TextField
                  ...
                  onChange={(e) => onFormChange('orderQuantity', e.target.value)}
                  placeholder="1"
                  required
                  fullWidth
                  size="small"
            ...
            <Stack direction="row" alignItems="center" justifyContent="space-between" sx={{ mb: ds.spacing['2'] }}>
              ...
              <Stack direction="row" spacing={ds.spacing['2']}>
                ...
                <Button
                  ...
                  disabled={!newItemForm.orderQuantity || !newItemForm.size || !newItemForm.productName}
                  size="small"
                  sx={{
                    textTransform: 'none',
                    borderRadius: `${ds.borderRadius.sm}px`,
            ...
            {profileCombinations.length > 0 && newItemForm.size && (
              ...
              >
                <Stack direction="row" alignItems="center" spacing={ds.spacing['2']}>
                  <LightbulbIcon sx={{ color: ds.colors.accent.main, fontSize: ds.componentSizes.icon.small }} />
                  <Box sx={{ flex: 1 }}>
                    <Typography sx={{ fontSize: '0.8125rem', fontWeight: 600, color: ds.colors.text.primary }}>
                      {profileCombinations.length} akıllı kombinasyon önerisi var
                    </Typography>
                  </Box>
                  <Button
                    size="small"
              ...
              <Stack spacing={ds.spacing['2']}>
                {newItemForm.profiles.map((profile, index) => (
                  <ProfileCard
                    ...
                    onChange={(field, value) => onProfileChange(profile.id, field, value)}
