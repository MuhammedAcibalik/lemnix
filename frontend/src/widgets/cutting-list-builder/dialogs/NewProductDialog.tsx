...
export const NewProductDialog: React.FC<NewProductDialogProps> = ({
  ...
  // Validation logic
  const validateProductName = useCallback((value: string): string | undefined => {
        ...
        <Stack spacing={ds.spacing['4']}>
          ...
          >
            <Stack direction="row" alignItems="center" spacing={ds.spacing['2']}>
              <InventoryIcon sx={{ color: ds.colors.warning.main, fontSize: ds.componentSizes.icon.medium }} />
              <Box>
          ...
          <Stack spacing={ds.spacing['3']}>
            <TextField
              ...
              helperText={errors.productName || `${productName.length}/50 karakter`}
              InputProps={{
                startAdornment: (
                  <InputAdornment position="start">
                    <CategoryIcon sx={{ 
                      color: errors.productName ? ds.colors.error.main : ds.colors.primary.main,
                      fontSize: ds.componentSizes.icon.medium,
                    }} />
                  </InputAdornment>
                ),
                endAdornment: productName.trim() && !errors.productName ? (
          ...
          {isFormValid && (
            ...
            >
              <Stack direction="row" alignItems="flex-start" spacing={ds.spacing['2']}>
                <CheckCircleIcon sx={{ 
                  color: ds.colors.success.main, 
                  fontSize: ds.componentSizes.icon.medium,
                  mt: 0.5,
                ...
                <Box sx={{ flex: 1 }}>
                  ...
                  <Typography sx={{ fontSize: '1rem', fontWeight: 600, color: ds.colors.text.primary }}>
                    {productName.trim()}
                  </Typography>
                </Box>
              </Stack>
