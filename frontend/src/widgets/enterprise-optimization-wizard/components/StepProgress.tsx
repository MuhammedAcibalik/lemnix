          ...
          return (
            <Tab
              ...
              sx={{
                ...
                fontSize: '0.8125rem',
                fontWeight: isActive ? ds.typography.fontWeight.semibold : ds.typography.fontWeight.medium,
                color: isDisabled
                ...
                '&:hover': {
                  color: isDisabled ? ds.colors.text.disabled : ds.colors.primary.main,
                  backgroundColor: isDisabled ? 'transparent' : alpha(ds.colors.primary.main, 0.04),
                },
                '&.Mui-disabled': {
