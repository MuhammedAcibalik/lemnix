 ...
 */
export const AlgorithmPerformanceCard: React.FC<AlgorithmPerformanceCardProps> = ({
  algorithm,
  executionTime,
  metadata,
}) => {
          ...
          <Stack spacing={ds.spacing['1']}>
            ...
            {metadata.bestFitness !== undefined && (
              <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                ...
                <Typography sx={{ fontSize: '0.8125rem', fontWeight: 600, color: ds.colors.success.main }}>
            ...
            {metadata.effectiveComplexity && (
              <Box sx={{ mt: ds.spacing['1'] }}>
                <Box sx={{ display: 'flex', alignItems: 'center', gap: ds.spacing['1'], mb: ds.spacing['1'] }}>
                  <CodeIcon sx={{ fontSize: 14, color: ds.colors.text.secondary }} />
