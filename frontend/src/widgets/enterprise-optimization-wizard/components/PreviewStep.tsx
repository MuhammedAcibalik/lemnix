            ...
            >
              <CardContent sx={{ p: ds.spacing["3"] }}>
                ...
                >
                  ...
                  <Divider
                    sx={{ borderColor: alpha(ds.colors.neutral[200], 0.5) }}
                  />
            ...
            >
              <CardContent sx={{ p: ds.spacing["3"] }}>
                ...
                >
                  ...
                  >
                    <AlgorithmIcon
                      sx={{ fontSize: 20, color: ds.colors.secondary.main }}
                    />
                    <Typography
                      sx={{
                        fontSize: "1rem",
                      ...
                      {params.objectives && params.objectives.length > 0 ? (
                        params.objectives.map((obj, idx) => (
                          <Chip
                            key={idx}
                            label={
                              obj.type === "minimize-waste"
                                ? "Atık Minimizasyonu"
                                : obj.type === "maximize-efficiency"
                                  ? "Verimlilik Maksimizasyonu"
                                  : obj.type === "minimize-cost"
                                    ? "Maliyet Minimizasyonu"
                                    : obj.type === "minimize-time"
                                      ? "Zaman Minimizasyonu"
                                      : obj.type
                            }
                            size="small"
        ...
        <Grid item xs={12} md={4}>
          ...
          >
            <CardContent sx={{ p: ds.spacing["3"] }}>
              ...
              >
                <FlagIcon
                  sx={{ fontSize: 20, color: ds.colors.success.main }}
                />
                <Typography
                  sx={{
                    fontSize: "1rem",
              ...
              >
                Tüm ayarlar kontrol edildi. Optimizasyon işlemini
                başlatabilirsiniz.
              </Typography>
