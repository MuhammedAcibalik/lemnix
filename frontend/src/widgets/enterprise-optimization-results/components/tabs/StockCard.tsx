        ...
        >
          ...
          <Box sx={{ mb: 2, display: 'flex', justifyContent: 'center' }}>
            <Button
              ...
              size="small"
              onClick={() => {
                console.log('🔍 StockCard Kesim Detayları clicked:', { isExpanded, stock });
              ...
              startIcon={<ExpandMoreIcon sx={{ transform: isExpanded ? 'rotate(180deg)' : 'rotate(0deg)', transition: 'transform 0.3s' }} />}
            >
              Kesim Detayları
            </Button>
          </Box>
          ...
          <Collapse in={isExpanded} timeout="auto" unmountOnExit>
            ...
            >
              <Grid container spacing={2}>
                <Grid item xs={6} sm={3}>
                  <Paper sx={{ p: 2, textAlign: 'center', background: 'rgba(59,130,246,0.05)', border: '1px solid rgba(59,130,246,0.1)', position: 'relative' }}>
                ...
                <Grid item xs={6} sm={3}>
                  <Paper sx={{ p: 2, textAlign: 'center', background: 'rgba(16,185,129,0.05)', border: '1px solid rgba(16,185,129,0.1)', position: 'relative' }}>
                    <Box sx={{ position: 'absolute', top: 8, right: 8 }}>
                      <InventoryIcon sx={{ fontSize: 16, color: 'success.main' }} />
                    </Box>
                ...
                <Grid item xs={6} sm={3}>
                  <Paper sx={{ p: 2, textAlign: 'center', background: 'rgba(245,158,11,0.05)', border: '1px solid rgba(245,158,11,0.1)', position: 'relative' }}>
                    <Box sx={{ position: 'absolute', top: 8, right: 8 }}>
                ...
                <Grid item xs={6} sm={3}>
                  <Paper sx={{ p: 2, textAlign: 'center', background: 'rgba(139,92,246,0.05)', border: '1px solid rgba(139,92,246,0.1)', position: 'relative' }}>
                    <Box sx={{ position: 'absolute', top: 8, right: 8 }}>
          ...
          >
            Bu gruptan kesilen toplam parça: 40 adet • Her profilden ortalama kalan atık: {stock.count ? Math.round(stock.waste / stock.count) : 0} mm
          </Typography>
        </CardContent>
      </Card>
    </Grid>
