...
import { formatPercentage, formatCurrency, formatDuration, getEfficiencyColor, getWasteColor } from './utils';
...
export const MetricsDisplay: React.FC<MetricsDisplayProps> = ({ 
  ...
  return (
    <Box sx={{ mb: 4 }}>
      {/* Algorithm Info */}
      <Card sx={{ mb: 3, background: 'linear-gradient(135deg, rgba(59,130,246,0.05) 0%, rgba(29,78,216,0.05) 100%)' }}>
        <CardContent>
              ...
              <CardContent>
                ...
                <Box sx={{ mb: 2 }}>
                  <Stack direction="row" justifyContent="space-between" alignItems="center" sx={{ mb: 1 }}>
                    ...
                    <Typography variant="caption" fontWeight="bold" color={metric.color}>
