        ...
        <Stack spacing={3} sx={{ mt: 1 }}>
          <FormControlLabel
            control={
              <Switch
                ...
                onChange={(e) =>
                  onSettingsChange({ showLabels: e.target.checked })
                }
              />
            }
          ...
          <FormControlLabel
            control={
              <Switch
                ...
                onChange={(e) =>
                  onSettingsChange({ showMeasurements: e.target.checked })
                }
              />
            }
          ...
          <FormControlLabel
            control={
              <Switch
                ...
                onChange={(e) =>
                  onSettingsChange({ showColors: e.target.checked })
                }
              />
            }
          ...
          <FormControlLabel
            control={
              <Switch
                ...
                onChange={(e) =>
                  onSettingsChange({ showWaste: e.target.checked })
                }
              />
            }
          ...
          <Box>
            ...
            <Slider
              ...
              onChange={(_, value) =>
                onSettingsChange({ zoomLevel: value as number })
              }
              min={0.5}
              max={3}
              step={0.1}
