  ...
  return (
    ...
    >
      ...
      <Box sx={{ position: 'relative', zIndex: 1 }}>
        ...
        {/* Value */}
        <Box sx={{ display: 'flex', alignItems: 'baseline', gap: ds.spacing['1'], mb: ds.spacing['1'] }}>
          <Typography
            sx={{
              fontSize: '2.25rem',
            ...
            <Box
              sx={{
                ...
                backgroundColor: alpha(
                  trendDirection === 'up' ? ds.colors.success.main : ds.colors.error.main,
                  0.1
                ),
              }}
            >
              <TrendIcon
                sx={{
                  fontSize: 16,
                  color: trendDirection === 'up' ? ds.colors.success.main : ds.colors.error.main,
                }}
              />
              <Typography
                sx={{
