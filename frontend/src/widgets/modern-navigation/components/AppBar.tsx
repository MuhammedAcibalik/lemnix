...
export const AppBar: React.FC<AppBarProps> = ({
  ...
  return (
      ...
      <Toolbar sx={{ 
        ...
        {/* Logo */}
        <Box sx={{ display: 'flex', alignItems: 'center', mr: ds.spacing['3'] }}>
          ...
          <Fade in={true} timeout={400}>
            ...
            >
              ...
              >
                ...
                >
                  {currentPageItem.icon && React.isValidElement(currentPageItem.icon) && (
                    React.cloneElement(currentPageItem.icon as React.ReactElement<{ sx?: Record<string, unknown> }>, { sx: { fontSize: 18 } })
                  )}
                </Box>
        ...
        <Box sx={{ 
          ...
          <Tooltip title="GPU Acceleration Status" arrow>
            <Box
              sx={{
                ...
                px: ds.spacing['2'],
                py: ds.spacing['1'],
                background: isSupported && isInitialized 
            ...
            >
              <Box
                sx={{
                  ...
                  animation: isSupported && isInitialized ? 'pulse 2s infinite' : 'none',
                  '@keyframes pulse': {
                    '0%': { opacity: 1 },
                    '50%': { opacity: 0.5 },
                    '100%': { opacity: 1 },
              ...
              <Typography
                sx={{
                  ...
                  color: isSupported && isInitialized 
                    ? ds.colors.success.main
                    : ds.colors.neutral[600],
                }}
              >
                {isLoading ? 'Kontrol ediliyor...' : 
                 isSupported && isInitialized ? 'GPU Aktif' : 'GPU Pasif'}
              </Typography>
            </Box>
          </Tooltip>
          ...
          <Tooltip title={messages.navigation.notificationsTooltip} arrow>
            ...
            >
              ...
              >
                <NotificationsIcon sx={{ fontSize: ds.componentSizes.icon.sm }} />
              </Badge>
            </IconButton>
          </Tooltip>
