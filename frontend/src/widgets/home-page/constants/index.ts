...
export const premiumFeatures: PremiumFeature[] = [
  ...
  },
  {
    ...
    description: 'Kesim planları ve performans metrikleri ile kapsamlı raporlama',
    badge: 'Analitik',
...
export const customerTestimonials: CustomerTestimonial[] = [
  {
    ...
    role: 'Üretim Müdürü',
    quote: 'LEMNİX sayesinde fire oranımızı %15\'ten %3\'e düşürdük. Malzeme tasarrufu inanılmaz!',
    avatar: 'AY',
    rating: 5,
  ...
  },
  {
    ...
    quote: 'Kesim planları ve optimizasyon raporları ile iş süreçlerimiz çok daha verimli hale geldi.',
    avatar: 'ED',
    rating: 5,
...
export const textContent = {
  hero: {
    ...
    description: '4 farklı optimizasyon algoritması ile alüminyum profil kesim verimliliğinizi maksimize edin. Fire oranını minimize eden, maliyet tasarrufu sağlayan profesyonel kesim planlama çözümü.',
