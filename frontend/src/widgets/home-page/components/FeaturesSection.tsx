...
const features = [
  {
    ...
    description: 'FFD, BFD, Genetic Algorithm v1.7.1, Profile Pooling algoritmaları ile %92+ verimlilik. GPU hızlandırma teknolojisi ile 2 saniyede sonuç.',
    badge: 'AI Algoritma'
  },
  {
    icon: FileSpreadsheet,
    title: 'Kapsamlı Kesim Listesi Yönetimi',
    description: 'Haftalık kesim listeleri, iş emri yönetimi, profil kombinasyonları ve akıllı öneriler. Gerçek zamanlı senkronizasyon ve otomatik güncelleme.',
    badge: 'Yönetim'
  },
  {
    icon: BarChart3,
    title: 'Gerçek Zamanlı Analiz ve Raporlama',
    description: 'Verimlilik %, Fire Oranı, Maliyet Analizi, Kesim Planı görselleştirmesi. ISO standartlarında denetlenebilir raporlama sistemi.',
    badge: 'Canlı Analiz'
  },
  {
    icon: Building2,
    title: 'Enterprise İş Emri Yönetimi',
    description: 'İş emri oluşturma, versiyon kontrolü, renk ve ebat yönetimi, profil kombinasyonları. Çoklu kullanıcı desteği ve rol tabanlı erişim.',
    badge: 'Enterprise'
  },
  {
    icon: ShieldCheck,
    title: 'Endüstriyel Standartlar ve Güvenlik',
    description: '6100mm stok uzunluğu, 3.5mm kerf genişliği, 2mm güvenlik payı ile gerçekçi hesaplamalar. Enterprise-grade güvenlik ve veri koruma.',
    badge: 'ISO Standart'
  },
  {
    icon: Layers,
    title: 'AI Destekli Akıllı Öneriler',
    description: 'Profil kombinasyonları, ebat önerileri, akıllı tamamlama ve geçmiş veri analizi. Machine learning algoritmaları ile sürekli öğrenen sistem.',
    badge: 'AI Öneri'
  }
];
    ...
    <Box sx={{ 
      ...
      <Container maxWidth="xl">
        ...
        <FadeIn direction="up" duration={0.5}>
          <Stack alignItems="center" spacing={ds.spacing['3']} sx={{ mb: ds.spacing['8'] }}>
                ...
                >
                  <Stack spacing={ds.spacing['3']}>
                    ...
                    <Stack direction="row" alignItems="center" justifyContent="space-between">
                      ...
                      >
                        <feature.icon sx={{ fontSize: 22, color: ds.colors.primary.main }} />
                      </Box>
