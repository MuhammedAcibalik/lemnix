...
export const ColorSizeAnalysis: React.FC<ColorSizeAnalysisProps> = ({ data }) => {
    ...
    <Box sx={{ p: 3 }}>
      ...
      <Box sx={{ mb: 4 }}>
        ...
        <Typography variant="body1" color="text.secondary">
          En popüler renk ve ebat seçimleri, kullanım oranları ve tercih analizleri
        </Typography>
      </Box>
          ...
          <Card sx={{ 
            ...
            <CardContent>
              <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                ...
                <Box>
                  <Typography variant="h4" sx={{ fontWeight: 'bold' }}>
                    {(data?.colorAnalysis?.length || 0) + (data?.sizeAnalysis?.length || 0)}
                  </Typography>
                  <Typography variant="body2" sx={{ opacity: 0.9 }}>
                    Farklı Seçenek
                  </Typography>
          ...
          <Card sx={{ 
            ...
            <CardContent sx={{ p: 3 }}>
              ...
              <Box sx={{ 
                ...
                <Box sx={{ flex: 1, ml: 2 }}>
                  {(data?.colorAnalysis || []).slice(0, 3).map((item, index) => (
                    <Box key={index} sx={{ 
                      display: 'flex',
                      justifyContent: 'space-between',
                      alignItems: 'center',
                      ...
                      <Box sx={{ display: 'flex', alignItems: 'center' }}>
                        <Box sx={{ 
                          ...
                          height: 10,
                          borderRadius: '50%',
                          bgcolor: colorDoughnutData.datasets[0].backgroundColor[index],
                          mr: 1
                        }} />
                    ...
                    <Box key={index} sx={{ 
                      ...
                      <Box sx={{ display: 'flex', alignItems: 'center' }}>
                        <Box sx={{ 
                          ...
                          height: 10,
                          borderRadius: '50%',
                          bgcolor: sizeDoughnutData.datasets[0].backgroundColor[index],
                          mr: 1
                        }} />
                        <Typography variant="body2" sx={{ 
                          fontWeight: 'bold',
              ...
              <Box sx={{ 
                ...
                <Box sx={{ 
                  ...
                  <Doughnut 
                    ...
                    options={getPremiumDoughnutOptions('Color-Size Combinations')}
                  />
                </Box>
                
                <Box sx={{ flex: 1, ml: 2 }}>
                  {(data?.colorSizeCombinations || []).slice(0, 3).map((item, index) => (
                    <Box key={index} sx={{ 
                      display: 'flex',
                      justifyContent: 'space-between',
                      alignItems: 'center',
                      ...
                      <Box sx={{ display: 'flex', alignItems: 'center' }}>
                        <Box sx={{ 
                          ...
                          height: 10,
                          borderRadius: '50%',
                          bgcolor: combinationDoughnutData.datasets[0].backgroundColor[index],
                          mr: 1
                        }} />
                        <Typography variant="body2" sx={{ 
                          fontWeight: 'bold',
          ...
          <Card sx={{ 
            ...
            <CardContent sx={{ p: 3 }}>
              ...
              <Box sx={{ 
                ...
                <Box sx={{ flex: 1, ml: 3 }}>
                  {(data?.colorSizeCombinations || []).slice(0, 5).map((item, index) => (
                    <Box key={index} sx={{ 
                      display: 'flex',
                      justifyContent: 'space-between',
                      alignItems: 'center',
        ...
        <Grid item xs={12} md={4}>
          <Card sx={{ 
            ...
            <CardContent sx={{ p: 3 }}>
              ...
              <Stack spacing={2}>
                {(data?.colorSizeCombinations || []).slice(0, 8).map((combo, index) => (
                ...
                <Table size="small">
                  <TableHead>
                    <TableRow sx={{ bgcolor: 'grey.50' }}>
                      ...
                      <TableCell align="center" sx={{ fontWeight: 'bold' }}>Kullanım</TableCell>
                      <TableCell align="center" sx={{ fontWeight: 'bold' }}>Yüzde</TableCell>
                  ...
                  <TableBody>
                    {(data?.colorAnalysis || []).map((color, index) => (
                      <TableRow key={color.color} hover>
                        ...
                        <TableCell align="center">
                          <Chip 
                            label={parseFloat(color.percentage) > 20 ? 'Yüksek' : parseFloat(color.percentage) > 10 ? 'Orta' : 'Düşük'}
                            size="small"
                            color={parseFloat(color.percentage) > 20 ? 'success' : parseFloat(color.percentage) > 10 ? 'warning' : 'default'}
                            variant="outlined"
                          />
                        </TableCell>
                      </TableRow>
                  ...
                  <TableBody>
                    {(data?.sizeAnalysis || []).map((size, index) => (
                      <TableRow key={size.size} hover>
                        ...
                        <TableCell align="center">
                          <Chip 
                            label={parseFloat(size.percentage) > 20 ? 'Yüksek' : parseFloat(size.percentage) > 10 ? 'Orta' : 'Düşük'}
                            size="small"
                            color={parseFloat(size.percentage) > 20 ? 'success' : parseFloat(size.percentage) > 10 ? 'warning' : 'default'}
                            variant="outlined"
                          />
                        </TableCell>
                      </TableRow>
