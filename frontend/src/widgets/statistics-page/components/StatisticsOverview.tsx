        ...
        >
          <CardContent sx={{ p: 4 }}>
            ...
            <Typography variant="body1" sx={{ opacity: 0.9, lineHeight: 1.6 }}>
              ...
              <strong>{data?.totalCuttingLists || 0}</strong> kesim listesi
              içinde <strong>{data?.totalWorkOrders || 0}</strong> iş emri
              bulunuyor. Toplam{" "}
              <strong>{(data?.totalProfiles || 0).toLocaleString()}</strong>{" "}
              profil adedi <strong>0</strong> farklı ürün kategorisinde
              işleniyor.
              <strong> 0</strong> iş emri tamamlandı, <strong>0</strong> iş emri
              bekliyor.
            </Typography>
          </CardContent>
        </Card>
