...
const WorkOrderAnalysis: React.FC<WorkOrderAnalysisProps> = ({
  cuttingListId,
}) => {
  const [workOrderStats, setWorkOrderStats] = useState<WorkOrderStats | null>(
    null,
  );
                      ...
                      <Box sx={{ display: "flex", alignItems: "center" }}>
                        <Box
                          sx={{
                            ...
                            borderRadius: "50%",
                            bgcolor:
                              priorityDoughnutData.datasets[0]
          ...
          <Box sx={{ textAlign: "center", mb: 8 }}>
            ...
            <Typography
              ...
              sx={{
                ...
                mb: 4,
                background:
                  "linear-gradient(135deg, #059669 0%, #10b981 30%, #3b82f6 60%, #06b6d4 100%)",
            ...
            >
              Mevcut haftanın gerçek iş emri verileri ile detaylı analiz. Kesim
              listesindeki iş emirlerinin durumu ve haftanın 7 günü gösterilir.
            </Typography>
          </Box>
            ...
            {trendChartData.length > 0 ? (
                    ...
                    <Box
                      ...
                      sx={{
                        ...
                        "&:hover": {
                          ...
                          boxShadow:
                            "0 30px 80px rgba(16, 185, 129, 0.15), 0 0 0 1px rgba(255, 255, 255, 0.9)",
                          "&::before": {
                            opacity: 1,
                          },
                        },
                              ...
                              return (
                                <Box
                                  ...
                                  sx={{
                                    ...
                                    borderRadius: "50%",
                                    background:
                                      "linear-gradient(135deg, rgba(59, 130, 246, 0.25) 0%, rgba(6, 182, 212, 0.25) 100%)",
              ...
              <Grid item xs={12}>
                ...
                >
                  ...
                  >
                    Seçilen kesim listesinde henüz iş emri bulunmuyor. İş emri
                    eklediğinizde burada timeline analizi görünecektir.
                  </Typography>
                </Box>
              </Grid>
            )}
              ...
              >
                ...
                >
                  {trendChartData.reduce(
                    (sum, trend) => sum + trend.completed + trend.pending,
                    0,
                  )}
                </strong>{" "}
                iş emri bulunuyor. Kesim listesindeki gerçek iş emri verileri
                ile hesaplanan analiz.
              </Typography>
            </Box>
          )}
        </Box>
              ...
              {selectedWeek && (
                <Box>
                  ...
                  >
                    ...
                    Haftanın Günleri ({selectedWeek.weekStart} -{" "}
                    {selectedWeek.weekEnd})
                  </Typography>

                  <Grid container spacing={2} sx={{ mb: 4 }}>
                    {selectedWeek.weekDays?.map(
                  ...
                  >
                    <CalendarMonthIcon
                      sx={{ color: premiumTheme.colors.primary }}
                    />
                    Hafta Tarih Aralığı
                  </Typography>
                  ...
                  <Grid container spacing={2} sx={{ mb: 4 }}>
                    ...
                    <Grid item xs={12} sm={6}>
                      ...
                      >
                        ...
                        <Typography variant="h6" sx={{ fontWeight: "bold" }}>
                          {selectedWeek.weekEnd
                            ? new Date(selectedWeek.weekEnd).toLocaleDateString(
                                "tr-TR",
                                {
                                  weekday: "long",
                                  year: "numeric",
