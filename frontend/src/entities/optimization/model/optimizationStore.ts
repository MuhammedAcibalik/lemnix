 ...
 * ```
 */
export const useOptimizationUI = create<OptimizationUIState & OptimizationUIActions>()(
  devtools(
    (set) => ({
      ...initialState,
      ...
      toggleAlgorithm: (algorithm) => set((state) => {
      ...
      toggleCutExpanded: (cutId) => set((state) => {
