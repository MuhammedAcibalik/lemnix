/**
 * @fileoverview Production Plan Page
 * @module pages/production-plan-page
 * @version 1.0.0
 */

import React, { useState, useEffect } from 'react';
import { Box, Typography, Button, Grid, useTheme, Dialog, DialogTitle, DialogContent, DialogActions } from '@mui/material';
...
// import { CreateCuttingListDialog } from '@/features/create-cutting-list-from-plan';
...
export const ProductionPlanPage: React.FC = () => {
  ...
  // const [createCuttingListDialogOpen, setCreateCuttingListDialogOpen] = useState(false);
  ...
  console.log('🚨 EXTRA DEBUG - Data Source Check:', {
    ...
    currentPage: 'production-plan-page'
  });
  ...
  return (
    ...
    >
      ...
      {/* Create Cutting List Dialog - Removed, using existing cutting list page instead */}
    </Box>
  );
};
