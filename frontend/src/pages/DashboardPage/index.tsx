...
import { HeroMetricCard, useHeroMetrics } from '@/widgets/dashboard-v2/hero-metrics';
...
export default function DashboardPage() {
  ...
  // Data hooks
  const { metrics: heroMetrics, isLoading: heroLoading } = useHeroMetrics({ timeRange: '7d' });
  const { data: perfData, isLoading: perfLoading } = useOptimizationPerformance({ timeRange: '7d' });
