/**
 * @fileoverview Production Plan Statistics Service
 * @module services/productionPlanStatisticsService
 * @version 1.0.0
 */
...
export const productionPlanStatisticsService =
  new ProductionPlanStatisticsService(productionPlanRepository);
