...
export class SimpleValidationTest {
  ...
  public static testRemainingLengthCalculation(): void {
    ...
    console.log(`   Remaining: ${remainingLength}mm (stock - used - endSafety)`);
    console.log(`   Accounting check: ${usedLength} + ${remainingLength} + ${endSafety} = ${usedLength + remainingLength + endSafety}mm = ${stockLength}mm ✅`);
  }
  ...
  public static testStockSelection(): void {
    ...
    console.log(`✅ Item: ${itemLength}mm, Available stocks: [${stockLengths.join(', ')}]mm`);
  ...
  public static testMaxPiecesCalculation(): void {
    ...
    console.log(`✅ Stock: ${stockLength}mm, Item: ${itemLength}mm, Kerf: ${kerfWidth}mm`);
  ...
  public static testAccountingValidation(): void {
    ...
    console.log(`✅ Stock: ${stockLength}mm, Used: ${usedLength}mm, End Safety: ${endSafety}mm`);
    console.log(`   Final Used: ${finalUsedLength}mm (used + endSafety)`);
    console.log(`   Final Remaining: ${finalRemaining}mm`);
    console.log(`   Accounting check: ${finalUsedLength} + ${finalRemaining} = ${finalUsedLength + finalRemaining} ✅`);
  }
