...
export class GPUDetector {
  ...
  public static rankGPUs(gpus: DetectedGPUInfo[]): DetectedGPUInfo[] {
    return [...gpus].sort((a, b) => {
      ...
      return (
        b.capabilities.maxComputeInvocations -
        a.capabilities.maxComputeInvocations
      );
    });
  }
   ...
   */
  public static getBestGPU(
    gpus: DetectedGPUInfo[],
  ): DetectedGPUInfo | undefined {
   ...
   */
  public static meetsMinimumRequirements(
    gpu: DetectedGPUInfo,
    minMemoryMB: number = 512,
  ): boolean {
    return (
   ...
   */
  public static getRecommendedWorkgroupSize(
    gpu: DetectedGPUInfo,
    itemCount: number,
  ): number {
