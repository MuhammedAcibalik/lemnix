...
export class MetricsCalculator {
   ...
   */
  public static getAlgorithmComplexity(algorithm: AlgorithmLabel): PerformanceMetrics['algorithmComplexity'] {
    const complexities: Record<AlgorithmLabel, PerformanceMetrics['algorithmComplexity']> = {
      'ffd': 'O(n²)',
      'bfd': 'O(n²)',
      'genetic': 'O(n²)',
      'pooling': 'O(n²)',
   ...
   */
  public static calculateQualityScore(efficiency: number, totalWaste: number): number {
   ...
   */
  public static calculateCuttingComplexity(totalSegments: number, stockCount: number): number {
   ...
   */
  public static mapAlgorithmToEnum(algorithm: AlgorithmLabel): OptimizationAlgorithm {
