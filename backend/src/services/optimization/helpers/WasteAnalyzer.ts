...
import { Cut, WasteCategory, WasteDistribution, DetailedWasteAnalysis } from '../../../types';
...
export class WasteAnalyzer {
   ...
   */
  public static calculateWasteDistribution(cuts: ReadonlyArray<Cut>): WasteDistribution {
   ...
   */
  public static calculateDetailedWasteAnalysis(cuts: ReadonlyArray<Cut>): DetailedWasteAnalysis {
   ...
   */
  public static isReclaimable(remainingLength: number, minScrapLength: number): boolean {
   ...
   */
  public static calculateWastePercentage(totalWaste: number, totalStockLength: number): number {
   ...
   */
  public static calculateReclaimableWastePercentage(cuts: ReadonlyArray<Cut>): number {
  ...
  public static getWasteStatistics(
    ...
    return {
      ...
      wastePercentage: this.calculateWastePercentage(totalWaste, totalStockLength),
   ...
   */
  public static getEfficiencyCategory(efficiency: number): 'excellent' | 'good' | 'average' | 'poor' {
