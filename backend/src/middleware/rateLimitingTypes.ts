...
// Request flow types
export type RequestFlow = 'read' | 'write' | 'export' | 'optimization' | 'analysis';
...
export const FLOW_CONFIGS: Record<RequestFlow, ResourceProtectionConfig> = {
  read: {
    flow: 'read',
    level: 'low',
    sizeLimit: { maxBodySize: 1024 * 100, maxFileSize: 0, maxArrayLength: 1000 },
  ...
  write: {
    flow: 'write',
    level: 'medium',
    sizeLimit: { maxBodySize: 1024 * 1024, maxFileSize: 1024 * 1024 * 5, maxArrayLength: 5000 },
  ...
  export: {
    flow: 'export',
    level: 'high',
    sizeLimit: { maxBodySize: 1024 * 1024 * 10, maxFileSize: 1024 * 1024 * 50, maxArrayLength: 50000 },
  ...
  optimization: {
    flow: 'optimization',
    level: 'high',
    sizeLimit: { maxBodySize: 1024 * 1024 * 5, maxFileSize: 0, maxArrayLength: 10000 },
  ...
  analysis: {
    flow: 'analysis',
    level: 'medium',
    sizeLimit: { maxBodySize: 1024 * 500, maxFileSize: 0, maxArrayLength: 5000 },
    timeout: { request: 30000, query: 15000, export: 0 },
