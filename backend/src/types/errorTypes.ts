...
export const USER_MESSAGES = {
  ...
  [ErrorClass.BUSINESS]:
    "The operation could not be completed due to business rules. Please contact support if this persists.",
  [ErrorClass.INTEGRATION]:
    "A temporary service issue occurred. Please try again in a few moments.",
  [ErrorClass.SYSTEM]:
    "A system error occurred. Our team has been notified and is working to resolve it.",
} as const;
