 ...
 * Delete a section
 */
router.delete('/:listId/sections/:sectionId',
  validateParams(sectionParamsSchema),
  async (req: Request, res: Response) => {
    try {
      const { listId, sectionId } = getValidatedData<{ listId: string; sectionId: string }>(req);
 ...
 */
router.post('/:listId/sections/:sectionId/items',
  ...composeValidations({
 ...
 * Update an item
 */
router.put('/:listId/sections/:sectionId/items/:itemId',
  ...composeValidations({
 ...
 * Delete an item
 */
router.delete('/:listId/sections/:sectionId/items/:itemId',
  validateParams(itemParamsSchema),
  async (req: Request, res: Response) => {
    try {
      const { itemId } = getValidatedData<{ listId: string; sectionId: string; itemId: string }>(req);
