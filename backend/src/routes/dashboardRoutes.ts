 ...
 * Auth: Requires authentication (all authenticated users)
 */
router.get('/algorithm-performance', dashboardController.getAlgorithmPerformance);
...
logger.info('  GET  /api/dashboard/algorithm-performance - Get algorithm performance');
...
logger.info('  GET  /api/dashboard/profile-usage - Get profile usage statistics');
