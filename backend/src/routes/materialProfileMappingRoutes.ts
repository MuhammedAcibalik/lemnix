...
router.get(
  "/suggestions",
  materialProfileMappingController.getSuggestions.bind(
    materialProfileMappingController,
  ),
);
...
router.get(
  "/most-popular",
  materialProfileMappingController.getMostPopularMapping.bind(
    materialProfileMappingController,
  ),
);
...
router.get(
  "/similar",
  materialProfileMappingController.getSimilarSuggestions.bind(
    materialProfileMappingController,
  ),
);
...
router.post(
  "/",
  materialProfileMappingController.saveMappingFromUserInput.bind(
    materialProfileMappingController,
  ),
);
