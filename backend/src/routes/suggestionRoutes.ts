...
router.get('/products', async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    logger.error('Failed to get product suggestions', { error, query: req.query });
    res.status(500).json({
      success: false,
...
router.get('/profiles', async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    logger.error('Failed to get profile suggestions', { error, query: req.query });
    res.status(500).json({
      success: false,
 ...
 */
router.get('/combinations', async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    logger.error('Failed to get combination suggestions', { error, query: req.query });
    res.status(500).json({
      success: false,
